...
//        public uint CheckSubdivision(double[] point)
//        {
//            uint result = 0;
//            for (int i = 0; i < dimensions; i++)
//            {
...
//            if (node != null)
//            {
//                return Simulator.calculateForce2(forceNode, node);
//            }
//            else
//            {
...
//                {
//                    //calculate...
//                    return Simulator.calculateForce2(forceNode, centerOfMass);
//                }
//                else
//                {
//                    //recurse
...
//                    for (uint i = 0; i < 8; i++)
//                    {
//                        DynamicOrthtree? childNode = children[i];
//                        if (childNode != null)
//                        {
...
//        public double[] subBounds(uint octrant)
//        {
...
//                    uint octrant = CheckSubdivision(newNode);
//                    if (children[octrant] == null)
//                    {
//                        children[octrant] = new DynamicOrthtree(subBounds(octrant), newNode);
//                    }
//                    else
//                    {
...
//                {
//                    //Subdivide
//                    uint octrant1 = CheckSubdivision(node);
//                    uint octrant2 = CheckSubdivision(newNode);
//                    if (children[octrant1] == null)
//                    {
//                        children[octrant1] = new DynamicOrthtree(subBounds(octrant1), node);
//                    }
//                    else
//                    {
...
//                    {
//                        children[octrant2] = new DynamicOrthtree(subBounds(octrant2), newNode);
//                    }
//                    else
//                    {
